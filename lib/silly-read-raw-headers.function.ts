 ...
 *
 * Compared with nodes header algorithm this method won't change case so 'X-Test-Header' will be 'X-Test-Header and won't get converted to 'x-test-header'.
 * That's important because case conversion in headers caused different results in proxied and direct requests in some use-cases.
 *
